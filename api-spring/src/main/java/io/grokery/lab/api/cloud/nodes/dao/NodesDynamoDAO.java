...
public class NodesDynamoDAO extends DynamoDAO {
	...
	private static final Logger logger = LoggerFactory.getLogger(NodesDynamoDAO.class);
	private static final String TABLENAME = "grokery-nodes";
	private Table table;

	public NodesDynamoDAO(CloudContext context) {
		super(context);
		logger.info("init new nodes dynamo dao instance");
