...
rm -r api-serverless/src/main/java/io/grokery/lab/api/admin
rm -r api-serverless/src/main/java/io/grokery/lab/api/common
rm -r api-serverless/src/main/java/io/grokery/lab/api/cloud
...
cp -r api-spring/src/main/java/io/grokery/lab/api/cloud api-serverless/src/main/java/io/grokery/lab/api/
