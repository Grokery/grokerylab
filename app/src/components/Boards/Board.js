    ...
    return (
      <div className='sidebar-page-content'>
        <div>
          ...
          {/* <Link to={'/clouds/'+cloudName+'/flows/board/'+node.nodeId+'?flow=open&activeTab=0'} style={{position: 'absolute', right:25, padding:15}}><i className='fa fa-pencil fa-fw'></i></Link> */}
          <Link to={'/clouds/'+cloudName+'/boards'} style={{position: 'absolute', right:0, padding:15}}><i className='fa fa-times'></i></Link>
